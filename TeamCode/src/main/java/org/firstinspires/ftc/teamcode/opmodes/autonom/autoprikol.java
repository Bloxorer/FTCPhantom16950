 ...
 *YES
 */
@Autonomous(name= "A_mid_krasn", group="Autonomous")
//
public class autoprikol extends Methods {
    ...
    private static float[] rightPos = {2.85f / 8f + offsetX, 4 / 8f + offsetY};
    ...
    public void runOpMode() throws InterruptedException {
        ...
        /*TrajectorySequence lefttrajectory = drive.trajectorySequenceBuilder(new Pose2d(0, 0, Math.toRadians(0.00)))
        ...
        /*TrajectorySequence lefttrajectory = drive.trajectorySequenceBuilder(new Pose2d(0,0, Math.toRadians(0.00)))
                ...
                .strafeLeft(2,SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();*/
