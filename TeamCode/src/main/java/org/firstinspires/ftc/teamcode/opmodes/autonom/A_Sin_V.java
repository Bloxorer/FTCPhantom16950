 ...
 *YES
 */
@Autonomous(name= "A_sin_v", group="Autonomous")
//
public class A_Sin_V extends Methods {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            static class StageSwitchingPipeline extends OpenCvPipeline {
                ...
                private middle_sin.StageSwitchingPipeline.Stage stageToRenderToViewport = middle_sin.StageSwitchingPipeline.Stage.detection;
                private  middle_sin.StageSwitchingPipeline.Stage[] stages = middle_sin.StageSwitchingPipeline.Stage.values();
